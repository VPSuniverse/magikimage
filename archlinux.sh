...
extract_image() {
  ...
  local archlinux_mirror='https://geo.mirror.pkgbuild.com'
  ...
  debug "# archlinux-bootstrap: add mirror to /etc/pacman.d/mirrorlist"
  ...
  debug "# add mirror to /etc/pacman.d/mirrorlist"
