...
export COMPANY="VPS Universe"
export C_SHORT="vpsuniverse"
export LOCKFILE='/run/lock/magikimage'
...
export NTPSERVERS=("time.google.com" "time1.google.com" "time.cloudflare.com")
...
export CPANEL_INSTALLER_SRC=http://mirror.app-dns.com/tools/cpanelinc/cpanel

export PLESK_INSTALLER_SRC=http://mirror.app-dns.com/tools/parallels/plesk
export PLESK_MIRROR=http://mirror.app-dns.com/plesk
